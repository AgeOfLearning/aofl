...
describe('@aofl/router/router', function() {
  ...
  context('Navigation', function() {
    ...
    it('Should match "/home" route and navigate to it', function() {
    ...
    it('Should match "/home" route and navigate to it and call replace state', function() {
      return new Promise((resolve) => {
        this.router.after((request, response, next) => {
          next(response);
          setTimeout(() => {
    ...
    it('Should have matchedRoute on routerInstance', function() {
      return new Promise((resolve) => {
        this.router.after((request, response, next) => {
    ...
    it('Should match dynamic "/about/mike/" route and navigate to it', function() {
      return new Promise((resolve) => {
        this.router.after((request, response, next) => {
    ...
    it('Should match nested dynamic "/about/mike/title/programmer" route and navigate to it', function() {
      try {
        new Promise((resolve) => {
          this.router.after((request, response, next) => {
