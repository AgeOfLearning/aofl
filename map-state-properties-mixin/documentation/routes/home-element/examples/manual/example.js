...
///////////////////////////////////////////////////////////////////////////////////////
class ManualComponent extends AoflElement {
  static get is() {
  ...
  connectedCallback() {
    ...
    storeInstance.subscribe(() => this.mapStateProperties());
  }
...
if (!customElements.get(ManualComponent.is)) {
  customElements.define(ManualComponent.is, ManualComponent);
}
...
let component = document.createElement(ManualComponent.is);
